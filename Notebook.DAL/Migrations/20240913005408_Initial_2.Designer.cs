...
namespace Notebook.DAL.Migrations
{
    ...
    [Migration("20240913005408_Initial_2")]
            ...
            modelBuilder.Entity("Notebook.Domain.Entity.Report", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 13, 0, 54, 5, 432, DateTimeKind.Utc).AddTicks(945),
                            CreatedBy = 0L,
                            Description = "test1",
                            Title = "rep1",
                            UserId = 1L
            ...
            modelBuilder.Entity("Notebook.Domain.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 13, 0, 54, 5, 435, DateTimeKind.Utc).AddTicks(6655),
                            CreatedBy = 0L,
                            Login = "User1",
                            Password = "--------------------"
                        });
            ...
            modelBuilder.Entity("Notebook.Domain.Entity.UserToken", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RefreshTokenExpireTime = new DateTime(2024, 9, 20, 0, 54, 5, 436, DateTimeKind.Utc).AddTicks(2245),
                            UserId = 1L
                        });
                });
